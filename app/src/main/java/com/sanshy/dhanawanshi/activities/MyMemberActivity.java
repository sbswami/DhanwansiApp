...
import com.sanshy.dhanawanshi.SingleAdapters.MyMemberSingleAdapter;
...
public class MyMemberActivity extends AppCompatActivity {
    ...
    ArrayList<MyMemberSingleItem> ItemList = new ArrayList<>();
    MyMemberSingleAdapter ListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter = new MyMemberSingleAdapter(ItemList, new MyMemberSingleAdapter.MyAdapterListener() {
            @Override
    ...
    public void SearchDataMethod(){
        if (
                ...
                &&TahsilSt.isEmpty()
                &&VillageSt.isEmpty()
                &&CastSt.isEmpty()&&EducationSt.isEmpty()
                ){
        ...
        if (searchView.getText().toString().isEmpty()){
            if (lastDocumentSnapshot!=null){
                ST.ShowProgress(MyMemberActivity.this);
                if (StateSt.isEmpty()){
...
//                .addOnFailureListener(FailureListener);
    ...
    OnSuccessListener<QuerySnapshot> SuccessListener = new OnSuccessListener<QuerySnapshot>() {
        ...
        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
            ...
            for (DocumentSnapshot documentSnapshot: queryDocumentSnapshots){
                MyMemberSingleItem item = new MyMemberSingleItem(
                        ...
                        documentSnapshot.contains(ST.EDITING_KEY)?(String) documentSnapshot.get(ST.EDITING_KEY):"",
    ...
    OnFailureListener FailureListener = new OnFailureListener() {
        ...
        public void onFailure(@NonNull Exception e) {
            ST.HideProgress();
            ST.ShowDialog(MyMemberActivity.this,e.toString());
        }
    };
        ...
        ST.SearchSuggetion.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()){
                    ...
                    ST.setSnipper(MyMemberActivity.this,searchView,SearchList);
                }
            }
        });
...
//        MaxAge = FilterView.findViewById(R.id.filter_max_age);
        ...
        ST.setSnipper(MyMemberActivity.this,State,StateList);
        ST.setSnipper(MyMemberActivity.this,Cast,CastList);
                ...
                ST.DistrictList(State.getText().toString()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        if (documentSnapshot.exists()){
                            ...
                            ST.setSnipper(MyMemberActivity.this,District,DistrictList);
                        }
                    }
                });
            }
                ...
                ST.TahsilList(State.getText().toString(),District.getText().toString()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        if (documentSnapshot.exists()){
                            ...
                            ST.setSnipper(MyMemberActivity.this,Tahsil,TahsilList);
                        }
                    }
                });
            }
                ...
                ST.VillageList(State.getText().toString(),District.getText().toString(), Tahsil.getText().toString()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        if (documentSnapshot.exists()){
                            ...
                            ST.setSnipper(MyMemberActivity.this,Village,VillageList);
                        }
                    }
                });
            }
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus){
                    if (State.getText().toString().isEmpty()){
                        ST.FillInput(MyMemberActivity.this);
                        District.clearFocus();
                    }
                    else{
